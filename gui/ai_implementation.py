...
class ChatGPTChat:
    ...
    def chat_interface(self, user_input):
        ...
        system_role = """You are a helpful expert for jobsearch and application. 
        You adapt the wording in regards to the job the user wants to apply for and provide additional information on companies and competitive market salaries on request.
        You write application letters in 3 concise paragraphs. The first highlights the connection between company and applicant, second give background info on applicants skills, 
        highlighting the relevant skills for the job, third is a short closing paragraph stating start date and salary if applicable."""  # DEFINE SYSTEM ROLE HERE
        global messages
